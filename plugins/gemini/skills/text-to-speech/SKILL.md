...
npx /path/to/scripts --model=gemini-2.5-flash-preview-tts "Hello, welcome to our application."

# Use a specific voice
npx /path/to/scripts --model=gemini-2.5-flash-preview-tts --voice=Puck "The quick brown fox jumps over the lazy dog."

# Generate longer narration
npx /path/to/scripts --model=gemini-2.5-flash-preview-tts --voice=Charon "In today's tutorial, we'll explore the fundamentals of machine learning."

# Use higher quality model for professional content
npx /path/to/scripts --model=gemini-2.5-pro-preview-tts --voice=Kore "This is a premium quality voice synthesis."
```
